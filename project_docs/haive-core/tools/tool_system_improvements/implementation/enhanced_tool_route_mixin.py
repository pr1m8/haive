...
class EnhancedToolRouteMixin(ToolRouteMixin):
    ...
    def _analyze_callable(self, callable_obj: Callable) -> Dict[str, Any]:
        ...
        """
        # Check cache first
        cache_key = f"{callable_obj.__module__}.{callable_obj.__qualname__}" if hasattr(callable_obj, "__qualname__") else str(callable_obj)
        ...
        try:
            ...
            if callable_obj.__doc__:
                ...
                metadata["docstring_preview"] = callable_obj.__doc__[:100] + "..." if len(callable_obj.__doc__) > 100 else callable_obj.__doc__
    ...
    def _analyze_pydantic_model(self, model: type[BaseModel]) -> Dict[str, Any]:
        ...
        try:
            ...
            metadata["has_validators"] = any(
                name.startswith("validate_") or name.startswith("validator_")
