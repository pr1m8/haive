...
class StructuredOutputMixin(BaseModel):
    ...
    # Parser management
    _structured_output_parser: Optional[BaseOutputParser] = None
    
    def with_structured_output(
        self,
        schema: Union[Dict[str, Any], Type[BaseModel]],
        *,
        method: Optional[StructuredOutputMethod] = None,
        include_raw: Optional[bool] = None,
        version: Optional[StructuredOutputVersion] = None,
        **kwargs
    ...
    def get_structured_output_parser(self) -> Optional[BaseOutputParser]:
    ...
    def bind_structured_output_tools(
        ...
        if self.structured_output_method != "tool_calling" and self.structured_output_version != "v2":
    ...
    def _validate_structured_output_config(self) -> "StructuredOutputMixin":
        ...
        elif self.structured_output_method == "tool_calling" and self.structured_output_version == "v1":
