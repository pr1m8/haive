"""
Unified Validation Node - Combines validation and routing in one step.
...
class UnifiedValidationNodeConfig(BaseNodeConfig):
    ...
    def __call__(self, state: Dict[str, Any], config: Optional[Dict[str, Any]] = None) -> Command:
        """
...
def create_unified_validation_node(
    ...
    **kwargs
    ...
    return UnifiedValidationNodeConfig(
        name=name,
