...
**Generated:** 2025-05-28T06:07:27.578810
...
```json
{
  "description": "No input required, but kept for LangChain compatibility.",
  "properties": {
    "dummy": {
      "anyOf": [
        {
...
```json
{
  "description": "Fetches OpenAQ location details by location ID.",
  "properties": {
    "location_id": {
      "title": "Location Id",
      "type": "integer"
...
Fetch nutrition and info about a specific fruit using its name from Fruityvice API
...
Get FRED series observations. Optional start and end date (YYYY-MM-DD).
...
**Tool Name:** `get_series_observations`
