...
"""
    ...
    for _i, _chunk in enumerate(doc.chunks[:3]):  # Show first 3 chunks
        pass
    ...
    for _i, _chunk in enumerate(doc.chunks):
        pass
    ...
    for _i, _chunk in enumerate(doc.chunks[:5]):  # Show first 5 sentences
        pass
