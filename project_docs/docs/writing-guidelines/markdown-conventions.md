...
- **Variables in text**: Replace *your_api_key* with your key
- **Book titles**: See *Design Patterns* for more details
...
*Figure 1: Agent execution workflow showing state transitions*
```
