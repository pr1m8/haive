...
_Example_: "Great! You've successfully created your first agent. Now let's add some tools to make it even more powerful."
...
_Example_: "Returns a `StateGraph` instance configured with the specified state schema and execution nodes."
...
_Example_: "This error typically occurs when the configuration is missing required fields. Here's how to fix it:"
...
- **Variable names in prose**: Replace _your_api_key_ with your actual key
- **Book/publication titles**: See _Design Patterns_ for more information
