...
class RealExamplesIntegrator:
    ...
    def discover_examples(self) -> List[ExampleOutput]:
        ...
        print("🔍 Discovering real examples in codebase...")
        ...
        print(f"📋 Found {len(self.examples)} real examples")
            ...
            for path in self.project_root.glob(pattern):
                if path.is_file():
                    try:
                        ...
                        print(f"⚠️  Skipping invalid JSON cache file {path}: {e}")
        ...
        if capture_dir.exists():
            for path in capture_dir.glob("*.json"):
                try:
                    ...
                    print(f"⚠️  Skipping invalid capture file {path}: {e}")
    ...
    def _calculate_duration(self, capture_data: Dict) -> Optional[float]:
...
"""
    ...
    def _create_agent_template(self, agent_type: str, examples: List[ExampleOutput], output_dir: Path):
...
"""
        ...
        print(f"📄 Created template for {agent_type} at {template_path}")
    
    def integrate_with_sphinx(self, docs_dir: Path):
        """Integrate examples with Sphinx documentation."""
        print("🔗 Integrating with Sphinx documentation...")
...
"""
        ...
        print("✅ Integration with Sphinx complete")
...
def main():
    ...
    print("\n✅ Real examples integration complete!")
    print(f"📁 Generated files in: {docs_dir / 'source' / 'real_examples'}")
