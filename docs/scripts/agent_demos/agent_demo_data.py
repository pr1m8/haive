...
AGENT_DATA = {
    ...
    temperature=0.7""",
        ...
        "graph_data": {
            "nodes": [
                ...
                {"id": "agent", "type": "agent", "label": "SimpleAgent", "description": "Main processing node"}
            ],
            "edges": [
            ...
            "executionTrace": [
                ...
                {"step": 2, "node": "agent", "status": "completed", "duration": 1.2, "output": "Processing..."},
    ...
    tools=[calculator_tool]""",
        ...
        "graph_data": {
            "nodes": [
                {"id": "start", "type": "start", "label": "START"},
                {"id": "think", "type": "agent", "label": "Think", "description": "Reasoning step"},
                {"id": "act", "type": "agent", "label": "Act", "description": "Action step"},
                {"id": "observe", "type": "agent", "label": "Observe", "description": "Observation step"},
                {"id": "end", "type": "end", "label": "END"}
            ],
            "edges": [
            ...
            "executionTrace": [
                {"step": 1, "node": "start", "status": "completed", "duration": 0.1, "output": "Initialized"},
                {"step": 2, "node": "think", "status": "completed", "duration": 1.5, "output": "Reasoning..."},
                {"step": 3, "node": "act", "status": "completed", "duration": 0.8, "output": "Acting..."},
                {"step": 4, "node": "observe", "status": "completed", "duration": 0.3, "output": "Observing..."},
                {"step": 5, "node": "end", "status": "completed", "duration": 0.1, "output": "Finished"}
            ]
        },
        "state_history": [
            {
            ...
            },
            {
                "timestamp": "2025-01-08T10:00:01Z",
                "step": 2,
                "state": {"status": "thinking", "input": "User query", "thoughts": "Need to calculate..."},
    ...
    retriever=vector_store_retriever""",
        ...
        "graph_data": {
            "nodes": [
                {"id": "start", "type": "start", "label": "START"},
                {"id": "retrieve", "type": "agent", "label": "Retrieve", "description": "Knowledge retrieval"},
                {"id": "generate", "type": "agent", "label": "Generate", "description": "Response generation"},
                {"id": "end", "type": "end", "label": "END"}
            ],
            "edges": [
            ...
            "executionTrace": [
                {"step": 1, "node": "start", "status": "completed", "duration": 0.1, "output": "Initialized"},
                {"step": 2, "node": "retrieve", "status": "completed", "duration": 0.8, "output": "Retrieved docs"},
                {"step": 3, "node": "generate", "status": "completed", "duration": 1.5, "output": "Generated response"},
                {"step": 4, "node": "end", "status": "completed", "duration": 0.1, "output": "Finished"}
            ]
        },
        "state_history": [
            {
            ...
            },
            {
                "timestamp": "2025-01-08T10:00:01Z",
                "step": 2,
                "state": {"status": "retrieving", "input": "User query", "documents": ["doc1", "doc2"]},
