...
Get started with core functionality:
...
Includes tools, games, and extras:

.. code-block:: bash

    pip install haive-core haive-agents haive-tools haive-games

**🛠️ Development Install** (Contributors)
For contributing to Haive:
...
.. note::
   ...
   🔑 **API Key Setup**: Most examples require an OpenAI API key. Set it with:
