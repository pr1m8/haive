...
.. grid:: 2 2 2 3
    ...
    .. grid-item-card:: 🤖 Agent Examples
        :link: auto_examples_agents/index
        :link-type: doc
    ...
    .. grid-item-card:: 🛠️ Tool Examples  
        :link: auto_examples_tools/index
        :link-type: doc
        :class-card: showcase-card
    ...
    .. grid-item-card:: 🎮 Game Examples
        :link: auto_examples_games/index
        :link-type: doc
        :class-card: showcase-card
...
.. grid:: 1 1 2 2
    ...
    .. grid-item-card:: 🎯 Tic-Tac-Toe AI Battle
        :link: auto_examples_games/tic_tac_toe_example
        :link-type: doc
    ...
    .. grid-item-card:: 🔧 Custom Tool Creation
        :link: auto_examples_tools/custom_tools_example  
        :link-type: doc
        :class-card: featured-card
