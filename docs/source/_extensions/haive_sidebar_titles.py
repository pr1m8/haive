"""Custom Sphinx extension to provide better sidebar titles for Haive.
...
def process_toctree_entries(app: Sphinx, doctree: nodes.document,
                            docname: str) -> None:
...
def add_module_title_to_page(
    ...
    if pagename.startswith(('api/generated/', 'generated/')):
        ...
        module_name = pagename.replace('api/generated/',
                                       '').replace('generated/', '')
