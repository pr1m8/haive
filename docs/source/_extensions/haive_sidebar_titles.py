...
def add_module_title_to_page(app: Sphinx, pagename: str, templatename: str, 
                            context: Dict[str, Any], doctree: nodes.document) -> None:
    """Add a human-readable title to module pages."""
    # Check if this is a module page
    if pagename.startswith('api/generated/') or pagename.startswith('generated/'):
...
def source_read_handler(app: Sphinx, docname: str, source: list) -> None:
    ...
    if docname.startswith('api/generated/') or docname.startswith('generated/'):
        content = source[0]
