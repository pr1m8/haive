...
results = await agent.arun(
    "Analyze global temperature trends for the last decade"
            ...
            <div class="agent-actions">
                ...
                <a href="/examples/climate_research.py" class="agent-button agent-button-secondary">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
agent = QuantumExplainerAgent(
    name="quantum_teacher",
...
explanation = await agent.arun(
    "Explain quantum entanglement in simple terms"
            ...
            <div class="agent-actions">
                ...
                <a href="/examples/quantum_education.py" class="agent-button agent-button-secondary">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polyline points="16 18 22 12 16 6"></polyline>
                        <polyline points="8 6 2 12 8 18"></polyline>
                    </svg>
...
findings = await agent.arun(
    "Research the latest developments in quantum computing"
            ...
            <div class="agent-actions">
                ...
                <a href="/examples/react_research.py" class="agent-button agent-button-secondary">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polyline points="16 18 22 12 16 6"></polyline>
                        <polyline points="8 6 2 12 8 18"></polyline>
                    </svg>
...
summary = await agent.arun(
    ...
    style="executive_summary"
            ...
            <div class="agent-actions">
                ...
                <a href="/examples/text_summarization.py" class="agent-button agent-button-secondary">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polyline points="16 18 22 12 16 6"></polyline>
                        <polyline points="8 6 2 12 8 18"></polyline>
                    </svg>
...
insights = await agent.arun(
    ...
    analysis_type="trend_analysis"
            ...
            <div class="agent-actions">
                ...
                <a href="/examples/simple_analysis.py" class="agent-button agent-button-secondary">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polyline points="16 18 22 12 16 6"></polyline>
                        <polyline points="8 6 2 12 8 18"></polyline>
                    </svg>
    ...
    async def process_task(self, task: str):
        ...
        return await self.execute_workflow(task)
            ...
            <div class="agent-actions">
                ...
                <a href="/templates/agent_template.py" class="agent-button agent-button-secondary">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
.. note::
   All agents in the Haive framework share a common interface while providing specialized capabilities for different use cases.

.. tip::
   Start with our pre-built agents and customize them as needed, or build completely custom agents using our flexible framework.
