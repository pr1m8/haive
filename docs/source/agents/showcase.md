...
Welcome to the comprehensive showcase of Haive's intelligent agent ecosystem! This showcase presents **243 agents** across **18 categories**, demonstrating the full breadth and power of the Haive framework.
...
**37 agents** | **Packages:** haive-agents
...
| **GraphDBRAGAgent**               | 🔴 Complex | retrieval, structured_output +1 | Graph Database RAG Agent for natural language querying of Neo4j databases.          |
...
| **SQLRAGAgent**                   | 🔴 Complex | retrieval, structured_output +1 | SQL RAG Agent for querying SQL databases with natural language.                     |
...
| **ReactAgent**                             | 🔴 Complex | reasoning, structured_output +1 | A tool-using agent implementing the ReAct pattern.                                  |
| **ReactAgent**                             | 🔴 Complex | reasoning, structured_output +1 | A React agent implementing the Reasoning-Action-Observation pattern.                |
...
| **ReactAgentState**                        | 🔴 Complex | reasoning, structured_output +1 | State for React Agent, extending SimpleAgentState.                                  |
...
| **ReactAgentState**                        | 🟡 Medium  | structured_output, tools +1     | State for React agents with tool usage.                                             |
...
| **LATSAgentConfig**         | 🔴 Complex | retrieval, reasoning +1        | Configuration for a Look-Ahead Tree Search (LATS) agent.                            |
...
| **SelfDiscoverAgent**       | 🔴 Complex | planning, structured_output +1 | An agent that implements the SelfDiscover methodology with structured output mod... |
...
| Agent                              | Complexity | Features                | Description                                               |
| ---------------------------------- | ---------- | ----------------------- | --------------------------------------------------------- |
| **AgentAction**                    | 🔴 Complex | retrieval, reasoning +1 | Model representing an agent's action decision.            |
...
| **AgentDecisionSchema** | 🔴 Complex | planning, structured_output +1  | Schema for LLM decision output.                                            |
...
| **PokerAgentConfig**    | 🟢 Simple  | retrieval, structured_output +1 | Configuration class for the poker agent.                                   |
...
| Agent                         | Complexity | Features                        | Description                                                                         |
| ----------------------------- | ---------- | ------------------------------- | ----------------------------------------------------------------------------------- |
| **PersonResearchAgent**       | 🔴 Complex | retrieval, structured_output +1 | Advanced person research agent with iterative information gathering capabilities... |
...
| **ResearchAgentConfig**       | 🟢 Simple  | retrieval, structured_output +1 | Configuration for open_perplexity research agent.                                   |
...
| **RewooAgent**             | 🔴 Complex | planning, reasoning +2      | ReWOO (Reasoning Without Observation) Agent implementation.         |
...
| Agent                           | Complexity | Features                    | Description                                                                      |
| ------------------------------- | ---------- | --------------------------- | -------------------------------------------------------------------------------- |
| **SimpleAgent**                 | 🔴 Complex | structured_output, tools +1 | Simple agent that modifies its engine to include structured output schema.       |
