...
Welcome to the comprehensive showcase of Haive's intelligent agent ecosystem! This showcase presents **362 agents** across **18 categories**, demonstrating the full breadth and power of the Haive framework.
...
| **Games** | 49 | `haive-games` |
| **ReAct & Tool Use** | 32 | `haive-agents` |
| **Specialized Agents** | 30 | `haive-agents` |
...
| **AgenticGraphRAGAgent** | 🔴 Complex | reasoning, retrieval +1 | Agentic Graph RAG - combines graph reasoning with agentic routing |
| **AgenticRAGAgent** | 🔴 Complex | structured_output, reasoning +2 | Agentic RAG agent combining ReAct reasoning with intelligent retrieval. |
...
| **DebateRAGAgent** | 🔴 Complex | reasoning, retrieval | Debate RAG - multiple agents with different perspectives debate |
...
| **GraphDBRAGAgent** | 🔴 Complex | structured_output, retrieval +1 | Graph Database RAG Agent for natural language querying of Neo4j databases. |
| **GraphRAGAgent** | 🔴 Complex | reasoning, retrieval | Graph RAG - uses knowledge graph construction and traversal |
...
| **MultiCriteriaGradedRAGAgentV2** | 🔴 Complex | structured_output, retrieval | Multi-Criteria Graded RAG V2 - Configuration stored in state schema. |
...
| **MultiQueryRetrievalAgent** | 🔴 Complex | structured_output, retrieval | Agent that uses a callable node for multi-query retrieval - proper Pydantic appr... |
...
| **QueryPlanningAgenticRAGAgent** | 🔴 Complex | reasoning, retrieval +1 | Query Planning Agentic RAG - creates detailed execution plans |
| **QueryPlanningRAGAgent** | 🔴 Complex | structured_output, retrieval +1 | Query Planning RAG agent with structured decomposition and execution. |
...
| **ReflexiveGradedRAGAgent** | 🔴 Complex | reasoning, retrieval +1 | Reflexive Graded RAG - uses grading feedback to improve its own performance |
| **SQLRAGAgent** | 🔴 Complex | structured_output, retrieval +1 | SQL RAG Agent for querying SQL databases with natural language. |
| **SelfCorrectiveRAGAgent** | 🔴 Complex | retrieval | RAG agent with self-correction capabilities. |
| **SelfRAGAgent** | 🔴 Complex | reasoning, retrieval | Self-RAG with reflection tokens - determines whether retrieval is needed |
| **SelfRAGAgent** | 🔴 Complex | reasoning, retrieval | Self-RAG with reflection tokens and adaptive retrieval. |
| **SelfRAGAgent** | 🔴 Complex | reasoning, retrieval | Self-RAG agent with reflection tokens and adaptive retrieval. |
| **SelfReflectiveAgenticRAGAgent** | 🔴 Complex | reasoning, retrieval | Self-Reflective Agentic RAG - continuously reflects on and improves |
| **SelfReflectiveRAGAgent** | 🔴 Complex | reasoning, retrieval | Self-Reflective RAG agent with iterative improvement capabilities. |
| **SelfRouteRAGAgent** | 🔴 Complex | reasoning, retrieval | Self-Route RAG - dynamically routes itself to different reasoning |
| **SelfRouteRAGAgent** | 🔴 Complex | structured_output, retrieval +1 | Complete Self-Route RAG agent with structured analysis and iterative planning. |
| **SimpleRAGAgent** | 🔴 Complex | conversation, retrieval +1 | Simple RAG agent that retrieves documents and provides basic answers. |
| **SimpleRAGWithMemoryAgent** | 🔴 Complex | memory, conversation +1 | Simple RAG with Memory - incorporates conversation history and previous queries |
...
| **StepBackRAGAgent** | 🔴 Complex | reasoning, retrieval | Complete Step-Back RAG agent with abstract reasoning. |
...
| **AdaptiveToolsRAGAgent** | 🟢 Simple | retrieval, tools | Complete Adaptive RAG agent with tools integration and ReAct patterns. |
...
| **AgenticRAGState** | 🟢 Simple | structured_output, retrieval | State schema for agentic RAG with retrieval metadata. |
| **AgenticRouterResult** | 🟢 Simple | retrieval | Complete result from agentic RAG routing. |
| **BaseRAGAgent** | 🟢 Simple | retrieval, tools | Simple base RAG agent with retrieve and generate functionality. |
...
| **EnhancedHyDERAGAgent** | 🟢 Simple | structured_output, retrieval +1 | Enhanced HyDE RAG Agent using the structured output enhancement pattern. |
...
| **FullyGradedRAGAgentV2** | 🟢 Simple | structured_output, retrieval | Fully Graded RAG V2 - Uses enhanced state schema with configuration support. |
...
| **SearchIntegrationAgent** | 🟢 Simple | retrieval, tools | Agent that integrates external search tools. |
...
**49 agents** | **Packages:** haive-games
...
| **MultiPlayerGameAgent** | 🔴 Complex | structured_output, tools | Base game agent for multi-player games. |
| **MultiPlayerGameAgent** | 🔴 Complex | structured_output, tools | Base game agent for multi-player games. |
...
| **ConfigurableConnect4Config** | 🟡 Medium | retrieval | Configurable Connect4 agent configuration. |
...
| **ConfigurableBattleshipConfig** | 🟢 Simple | Basic | Configurable Battleship configuration with dynamic LLM selection. |
| **ConfigurableDebateConfig** | 🟢 Simple | Basic | Configurable Debate configuration with dynamic LLM selection. |
| **ConfigurableDominoesConfig** | 🟢 Simple | Basic | Configurable Dominoes configuration with dynamic LLM selection. |
| **ConfigurableGameAgent** | 🟢 Simple | Basic | Abstract base for game agents with configurable players. |
| **ConfigurableHoldemConfig** | 🟢 Simple | Basic | Configurable Hold'em configuration with dynamic LLM selection. |
| **ConfigurableMonopolyConfig** | 🟢 Simple | Basic | Configurable Monopoly configuration with dynamic LLM selection. |
...
| **MonopolyPlayerAgentConfig** | 🟢 Simple | Basic | Configuration for monopoly player decision agent. |
| **PlayerAgentConfig** | 🟢 Simple | Basic | Configuration for a player agent. |
| **PlayerAgentFactory** | 🟢 Simple | Basic | Factory for creating configurable player agents. |
...
| **ReactAgent** | 🔴 Complex | structured_output, reasoning +1 | A tool-using agent implementing the ReAct pattern. |
| **ReactAgent** | 🔴 Complex | structured_output, reasoning +1 | A React agent implementing the Reasoning-Action-Observation pattern. |
...
| **ReactAgentConfig** | 🔴 Complex | memory, reasoning +1 | Configuration for a React agent that can use tools. |
...
| **ReactAgentState** | 🔴 Complex | structured_output, reasoning +1 | State for React Agent, extending SimpleAgentState. |
| **ReactManyToolsAgent** | 🔴 Complex | retrieval, tools | React Agent implementation that can handle many tools efficiently. |
| **DynamicReactAgent** | 🟡 Medium | tools | A React agent with dynamic tool selection. |
| **ReactAgent** | 🟡 Medium | Basic | No description available |
| **ReactAgentState** | 🟡 Medium | structured_output, memory +1 | State for React agents with tool usage. |
| **DynamicReactAgentConfig** | 🟢 Simple | tools | Configuration for a React agent with dynamic tool selection. |
| **DynamicReactAgentState** | 🟢 Simple | structured_output, tools | Extended schema for dynamic tool selection. |
...
| **ReactAgentSchema** | 🟢 Simple | structured_output, tools | Schema for React Agent State, extending SimpleAgentSchema. |
| **ReactAgentSchemaWithStructuredResponse** | 🟢 Simple | structured_output | Schema for React Agent with structured response. |
| **ReactAgentState** | 🟢 Simple | structured_output, tools | State schema for ReAct agent. |
| **ReactAgentState** | 🟢 Simple | Basic | The state of the agent. |
| **ReactAgentState** | 🟢 Simple | structured_output, tools | State schema for React agent. |
| **ReactManyToolsConfig** | 🟢 Simple | retrieval, tools | Configuration for React Agent with many tools. |
| **ReactManyToolsState** | 🟢 Simple | retrieval, tools | State for React Agent with many tools. |

### Specialized Agents

**30 agents** | **Packages:** haive-agents
...
| **ChainAgent** | 🔴 Complex | structured_output, tools | An agent that chains multiple engines together, passing output from one to the n... |
...
| **AgentInput** | 🟢 Simple | structured_output | Default input schema for agents. |
| **AgentOutput** | 🟢 Simple | structured_output | Default output schema for agents. |
| **AgentState** | 🟢 Simple | structured_output | Default state schema for agents. |
...
| **LATSAgentConfig** | 🔴 Complex | reasoning, retrieval +1 | Configuration for a Look-Ahead Tree Search (LATS) agent. |
...
| **ReflectionAgentState** | 🔴 Complex | structured_output, reasoning | State schema for the Reflection agent. |
| **SelfDiscoverAgent** | 🔴 Complex | structured_output, reasoning +1 | An agent that implements the SelfDiscover methodology with structured output mod... |
| **SelfDiscoverAgentConfig** | 🔴 Complex | structured_output, reasoning | Configuration for a SelfDiscover agent. |
...
| **LATSAgentConfig** | 🟢 Simple | retrieval, tools | Configuration for Language Agent Tree Search (LATS) agent. |
...
| **ComplexExtractionAgentConfig** | 🔴 Complex | structured_output, tools | Configuration for the complex extraction agent. |
| **DocumentAgent** | 🔴 Complex | memory, conversation +2 | Comprehensive Document Processing Agent. |
...
| **TaxonomyAgent** | 🔴 Complex | memory, conversation | Agent that generates a taxonomy from a conversation history. |
| **TaxonomyAgentConfig** | 🔴 Complex | memory, conversation | Agent configuration for generating a taxonomy from conversation history. |
...
| **MultiAgent** | 🔴 Complex | planning, conversation +3 | Abstract base class for sophisticated multi-agent systems. |
...
| Agent | Complexity | Features | Description |
|-------|------------|----------|-------------|
| **AgentAction** | 🔴 Complex | reasoning, retrieval +1 | Model representing an agent's action decision. |
...
**11 agents** | **Packages:** haive-games

| Agent | Complexity | Features | Description |
|-------|------------|----------|-------------|
| **AgentDecision** | 🔴 Complex | reasoning, planning | Agent's decision in the game. |
| **AgentDecisionSchema** | 🔴 Complex | structured_output, reasoning +1 | Schema for LLM decision output. |
...
| **ConfigurableCheckersConfig** | 🟢 Simple | Basic | Configurable Checkers configuration with dynamic LLM selection. |
| **ConfigurablePokerConfig** | 🟢 Simple | Basic | Configurable Poker configuration with dynamic LLM selection. |
...
| Agent | Complexity | Features | Description |
|-------|------------|----------|-------------|
| **SimpleAgent** | 🔴 Complex | structured_output, conversation +1 | Simple agent that modifies its engine to include structured output schema. |
| **SimpleAgentState** | 🔴 Complex | memory, conversation | Base state for simple agents. |
...
| **StructuredOutputAgentConfig** | 🟢 Simple | structured_output, tools | Configuration for a structured output agent. |
...
| Agent | Complexity | Features | Description |
|-------|------------|----------|-------------|
| **PersonResearchAgent** | 🔴 Complex | structured_output, reasoning +1 | Advanced person research agent with iterative information gathering capabilities... |
...
| **ResearchAgentConfig** | 🟢 Simple | structured_output, retrieval +1 | Configuration for open_perplexity research agent. |
...
| Agent | Complexity | Features | Description |
|-------|------------|----------|-------------|
| **LLMCompilerAgent** | 🔴 Complex | structured_output, planning | LLM Compiler Agent implementation. |
| **RewooAgent** | 🔴 Complex | structured_output, reasoning +2 | ReWOO (Reasoning Without Observation) Agent implementation. |
...
| Agent | Complexity | Features | Description |
|-------|------------|----------|-------------|
| **MemoryAgent** | 🔴 Complex | memory, conversation | Memory Agent implementation that extends ReactAgent. |
...
| Agent | Complexity | Features | Description |
|-------|------------|----------|-------------|
| **BaseConversationAgent** | 🔴 Complex | conversation, tools | Base conversation agent that orchestrates multi-agent conversations. |
...
| **RiskAgent** | 🔴 Complex | memory, reasoning +1 | Agent for playing the Risk game. |
