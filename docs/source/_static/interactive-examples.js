    ...
    class InteractiveExample {
        ...
        setupUI() {
            ...
            if (cachedResult) {
                ...
                outputSection.innerHTML = '<div class="output-placeholder">Click "Run Example" to see output</div>';
            }
        ...
        bindEvents() {
            ...
            toggleBtn.addEventListener('click', () => {
                ...
                toggleBtn.textContent = codeSection.classList.contains('hidden') ? '👁️ View Code' : '🙈 Hide Code';
            });
        }
        ...
        async runExample() {
            ...
            const runBtn = this.element.querySelector('.run-example-btn');
            const outputSection = this.element.querySelector('.example-output-section');
            ...
            outputSection.innerHTML = '<div class="output-loading">🔄 Executing example...</div>';
            ...
            const mockResults = {
                'chess': {
                    ...
                    moves: [
                        ...
                        'Bf1-c4', 'Bf8-c5', 'O-O', 'Ng8-f6'
                    ],
                    finalPosition: 'rnbqk2r/pppp1ppp/5n2/2b1p3/2B1P3/5N2/PPPP1PPP/RNBQ1RK1',
                    result: 'Game in progress',
                    analysis: {
                        white_advantage: '+0.3',
                        key_moves: ['e2-e4 (King\'s Pawn opening)', 'Bf1-c4 (Italian Game)'],
                        position_summary: 'Classical opening development. White has slight initiative.'
                    },
                    ui_output: `
┌───┬───┬───┬───┬───┬───┬───┬───┐
│ ♜ │ ♞ │ ♝ │ ♛ │ ♚ │   │   │ ♜ │ 8
...
⏱️ Moves played: 8 | Time: 0:02:34
                ...
                'simple': {
                    ...
                    messages: [
                        ...
                        {role: 'assistant', content: 'Hello! I\'m a Haive SimpleAgent. I can help you with various tasks including answering questions, providing information, and having conversations. What would you like to know or discuss?'}
                    ],
                    metadata: {
                        model: 'gpt-4o',
                        tokens_used: 156,
                ...
                'rag': {
                    ...
                    retrieved_docs: [
                        {source: 'chess/README.md', relevance: 0.95, snippet: 'ChessAgent is the main class for creating AI chess players...'},
                        {source: 'agents/base.py', relevance: 0.87, snippet: 'The Agent base class provides the foundation for all agents...'}
                    ],
                    response: 'To create a chess agent, you can use the ChessAgent class from haive.games.chess. Here\'s how to get started...',
                    metadata: {
                        retrieval_time: '0.3s',
