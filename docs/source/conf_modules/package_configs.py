...
This module defines extension profiles (minimal, standard, full) for each Haive package,
allowing targeted documentation builds with only the necessary extensions.
"""
