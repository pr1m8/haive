...
.. admonition:: TODO
  * * Document the base agent classes and extension points
  * * Add complete examples of custom agent implementations
  * * Include guidance on prompt design
  * * Provide performance optimization tips
  * * Document agent composition techniques
