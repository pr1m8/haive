...
For detailed API documentation, see the [API Reference](../../../docs/source/api/document_graders/index.rst).

## See Also

- [`document_graders.binary_grader`](./binary_grader/): TODO: Add description
