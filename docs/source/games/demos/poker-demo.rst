...
.. raw:: html
   ...
   <button onclick="startGame('poker')" class="start-game-btn">
...
.. raw:: html
   ...
   <div id="poker-board" class="game-board">
   <!-- Game board will be rendered here -->

.. raw:: html

   <div class="board-placeholder">
   <p>Click "Start New Game" to begin playing Poker</p>
   </div>
...
.. raw:: html
   ...
   <div id="poker-status" class="status-display">
...
.. raw:: html
   ...
   <div id="poker-moves" class="moves-history">
...
Learn the rules and strategies for Poker.
