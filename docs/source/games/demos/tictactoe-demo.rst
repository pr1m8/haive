...
- **Easy**: Beginner-friendly AI that makes some mistakes
- **Perfect**: Advanced AI using optimal strategies
...
.. code-block:: python
    ...
    from haive.games.tictactoe import Tic Tac ToeGame
    from haive.agents.simple import SimpleAgent

    # Create game
    game = Tic Tac ToeGame()
