...
.. raw:: html
   ...
   <span class="feature-tag">Asymmetric play</span>
   <span class="feature-tag">Capture mechanics</span>
   <span class="feature-tag">Strategic movement</span>
   <span class="feature-tag">Classic rules</span>
   </div>
...
.. raw:: html
   ...
   <h3>Play Fox and Geese</h3>

.. raw:: html

   <div class="ai-selection">
   <label>AI Difficulty:</label>
   <select id="fox_and_geese-ai-level">
...
.. raw:: html
   ...
   <button onclick="startGame('fox_and_geese')" class="start-game-btn">
...
.. raw:: html
   ...
   <div id="fox_and_geese-board" class="game-board">
   <!-- Game board will be rendered here -->

.. raw:: html

   <div class="board-placeholder">
   <p>Click "Start New Game" to begin playing Fox and Geese</p>
   </div>
...
.. raw:: html
   ...
   <div id="fox_and_geese-status" class="status-display">
...
.. raw:: html
   ...
   <div id="fox_and_geese-moves" class="moves-history">
...
.. raw:: html
   ...
   <div id="fox_and_geese-moves-stream">
...
Learn the rules and strategies for Fox and Geese.
...
.. code-block:: python
    ...
    from haive.games.fox_and_geese import FoxandGeeseGame
    from haive.agents.simple import SimpleAgent

    # Create game
    game = FoxandGeeseGame()
