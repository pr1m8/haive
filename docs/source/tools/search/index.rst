...
.. code-block:: python
   ...
   .. autofunction:: haive.tools.search.duckduckgo_search_tool

   .. autofunction:: haive.tools.search.google_search_tool

   .. autofunction:: haive.tools.search.tavily_search_tool

   .. Note: WikipediaSearchTool, ArxivSearchTool, and SemanticSearchTool

   are not yet implemented in the codebase but are planned features.
