...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_models.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_models.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 9-185
...
.. _sphx_glr_download_auto_examples_models.py:
