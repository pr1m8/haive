...
.. "auto_examples/mcp/basic_mcp_agent_fixed.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_mcp_basic_mcp_agent_fixed.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_mcp_basic_mcp_agent_fixed.py:

Example demonstrating basic MCP agent usage with type-checked integration.
Fixed version with correct imports.

.. GENERATED FROM PYTHON SOURCE LINES 4-238
...
.. _sphx_glr_download_auto_examples_mcp_basic_mcp_agent_fixed.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: basic_mcp_agent_fixed.ipynb <basic_mcp_agent_fixed.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: basic_mcp_agent_fixed.py <basic_mcp_agent_fixed.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: basic_mcp_agent_fixed.zip <basic_mcp_agent_fixed.zip>`
