...
.. "auto_examples/mcp/typed_mcp_aug_llm_example.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_mcp_typed_mcp_aug_llm_example.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_mcp_typed_mcp_aug_llm_example.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 8-335
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/home/will/Projects/haive/backend/haive/packages/haive-mcp/examples/typed_mcp_aug_llm_example.py", line 17, in <module>
        from haive.core.engine.aug_llm import MCPAugLLMConfig, create_mcp_aug_llm_config
    ImportError: cannot import name 'MCPAugLLMConfig' from 'haive.core.engine.aug_llm' (/home/will/Projects/haive/backend/haive/packages/haive-core/src/haive/core/engine/aug_llm/__init__.py)
...
.. _sphx_glr_download_auto_examples_mcp_typed_mcp_aug_llm_example.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: typed_mcp_aug_llm_example.ipynb <typed_mcp_aug_llm_example.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: typed_mcp_aug_llm_example.py <typed_mcp_aug_llm_example.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: typed_mcp_aug_llm_example.zip <typed_mcp_aug_llm_example.zip>`
