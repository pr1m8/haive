...
.. "auto_examples/mcp/dynamic_activation_mcp_example.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_mcp_dynamic_activation_mcp_example.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_mcp_dynamic_activation_mcp_example.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 14-859
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/home/will/Projects/haive/backend/haive/packages/haive-mcp/examples/dynamic_activation_mcp_example.py", line 23, in <module>
        from haive.mcp.dynamic_activation_mcp import (
      File "/home/will/Projects/haive/backend/haive/packages/haive-mcp/src/haive/mcp/dynamic_activation_mcp.py", line 213, in <module>
    ...
    pydantic.errors.PydanticUserError: Unrecognized field_validator function signature for <bound method DynamicActivationMCPServer.setup_mcp_server of <class 'haive.mcp.dynamic_activation_mcp.DynamicActivationMCPServer'>> with `mode=after`:() -> 'DynamicActivationMCPServer'
...
.. _sphx_glr_download_auto_examples_mcp_dynamic_activation_mcp_example.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: dynamic_activation_mcp_example.ipynb <dynamic_activation_mcp_example.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: dynamic_activation_mcp_example.py <dynamic_activation_mcp_example.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: dynamic_activation_mcp_example.zip <dynamic_activation_mcp_example.zip>`
