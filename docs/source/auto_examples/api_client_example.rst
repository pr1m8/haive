...
.. "auto_examples/api_client_example.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_api_client_example.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_api_client_example.py:

Example client for the Chess API.

This shows how to interact with the chess API to create and play games.

.. GENERATED FROM PYTHON SOURCE LINES 5-161
...
.. _sphx_glr_download_auto_examples_api_client_example.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: api_client_example.ipynb <api_client_example.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: api_client_example.py <api_client_example.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: api_client_example.zip <api_client_example.zip>`
