...
.. "auto_examples/agents/sequential_multi_agent_demo.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_agents_sequential_multi_agent_demo.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_agents_sequential_multi_agent_demo.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 12-391
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/examples/sequential_multi_agent_demo.py", line 390, in <module>
        asyncio.run(main())
      ...
      File "/usr/lib/python3.12/asyncio/base_events.py", line 687, in run_until_complete
        return future.result()
               ^^^^^^^^^^^^^^^
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/examples/sequential_multi_agent_demo.py", line 377, in main
        await demo_react_to_simple_structured()
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/examples/sequential_multi_agent_demo.py", line 125, in demo_react_to_simple_structured
      ...
      File "/home/will/Projects/haive/backend/haive/.venv/lib/python3.12/site-packages/pydantic/main.py", line 253, in __init__
        validated_self = self.__pydantic_validator__.validate_python(data, self_instance=self)
                         ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    pydantic_core._pydantic_core.ValidationError: 1 validation error for EnhancedMultiAgentV4
    agents.0
      Input should be a valid dictionary or instance of Agent [type=model_type, input_value=SimpleAgentV2(name='analy... structured_output=None), input_type=ReactAgent]
...
.. _sphx_glr_download_auto_examples_agents_sequential_multi_agent_demo.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: sequential_multi_agent_demo.ipynb <sequential_multi_agent_demo.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: sequential_multi_agent_demo.py <sequential_multi_agent_demo.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: sequential_multi_agent_demo.zip <sequential_multi_agent_demo.zip>`
