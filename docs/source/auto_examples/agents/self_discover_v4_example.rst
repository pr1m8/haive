...
.. "auto_examples/agents/self_discover_v4_example.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_agents_self_discover_v4_example.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_agents_self_discover_v4_example.py:
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/examples/self_discover_v4_example.py", line 8, in <module>
...
.. _sphx_glr_download_auto_examples_agents_self_discover_v4_example.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: self_discover_v4_example.ipynb <self_discover_v4_example.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: self_discover_v4_example.py <self_discover_v4_example.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: self_discover_v4_example.zip <self_discover_v4_example.zip>`
