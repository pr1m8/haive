...
.. "auto_examples/agents/output_adapter_demo.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_agents_output_adapter_demo.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_agents_output_adapter_demo.py:

Demo of OutputAdapter and transformation functionality.

.. GENERATED FROM PYTHON SOURCE LINES 2-237
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/examples/output_adapter_demo.py", line 8, in <module>
        from haive.agents.base.mixins.output_mixin import OutputAdapter, OutputMixin
    ModuleNotFoundError: No module named 'haive.agents.base.mixins.output_mixin'
...
.. _sphx_glr_download_auto_examples_agents_output_adapter_demo.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: output_adapter_demo.ipynb <output_adapter_demo.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: output_adapter_demo.py <output_adapter_demo.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: output_adapter_demo.zip <output_adapter_demo.zip>`
