...
.. "auto_examples/agents/dynamic_supervisor_example.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_agents_dynamic_supervisor_example.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_agents_dynamic_supervisor_example.py:
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/examples/dynamic_supervisor_example.py", line 11, in <module>
        from haive.core.models.llm.base import AzureLLMConfig, ModelType
    ImportError: cannot import name 'ModelType' from 'haive.core.models.llm.base' (/home/will/Projects/haive/backend/haive/packages/haive-core/src/haive/core/models/llm/base.py)
...
.. _sphx_glr_download_auto_examples_agents_dynamic_supervisor_example.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: dynamic_supervisor_example.ipynb <dynamic_supervisor_example.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: dynamic_supervisor_example.py <dynamic_supervisor_example.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: dynamic_supervisor_example.zip <dynamic_supervisor_example.zip>`
