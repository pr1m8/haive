...
.. "auto_examples/agents/generalized_hooks_example.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_agents_generalized_hooks_example.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_agents_generalized_hooks_example.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 14-415
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    🎯 Generalized Hook System Examples
    Demonstrating advanced hook patterns for enhanced agents
    ...
    ❌ Example execution failed: 'SimpleAgent' object has no attribute 'before_run'
    Traceback (most recent call last):
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/examples/generalized_hooks_example.py", line 394, in main
        await example_basic_hooks()
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/examples/generalized_hooks_example.py", line 56, in example_basic_hooks
        @agent.before_run
         ^^^^^^^^^^^^^^^^
      File "/home/will/Projects/haive/backend/haive/.venv/lib/python3.12/site-packages/pydantic/main.py", line 994, in __getattr__
        raise AttributeError(f'{type(self).__name__!r} object has no attribute {item!r}')
    AttributeError: 'SimpleAgent' object has no attribute 'before_run'
...
.. _sphx_glr_download_auto_examples_agents_generalized_hooks_example.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: generalized_hooks_example.ipynb <generalized_hooks_example.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: generalized_hooks_example.py <generalized_hooks_example.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: generalized_hooks_example.zip <generalized_hooks_example.zip>`
