...
.. "auto_examples/agents/supervisor/dynamic_agent_discovery_example.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_agents_supervisor_dynamic_agent_discovery_example.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_agents_supervisor_dynamic_agent_discovery_example.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 9-342
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/examples/supervisor/dynamic_agent_discovery_example.py", line 18, in <module>
        from haive.agents.supervisor.dynamic_agent_discovery_supervisor import (
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/src/haive/agents/supervisor/__init__.py", line 3, in <module>
        from haive.agents.supervisor.agent import (
    ImportError: cannot import name 'build_graph' from 'haive.agents.supervisor.agent' (/home/will/Projects/haive/backend/haive/packages/haive-agents/src/haive/agents/supervisor/agent.py)
...
.. _sphx_glr_download_auto_examples_agents_supervisor_dynamic_agent_discovery_example.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: dynamic_agent_discovery_example.ipynb <dynamic_agent_discovery_example.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: dynamic_agent_discovery_example.py <dynamic_agent_discovery_example.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: dynamic_agent_discovery_example.zip <dynamic_agent_discovery_example.zip>`
