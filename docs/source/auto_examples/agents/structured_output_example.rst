...
.. "auto_examples/agents/structured_output_example.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_agents_structured_output_example.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_agents_structured_output_example.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 6-209
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/examples/structured_output_example.py", line 14, in <module>
        from haive.agents.structured import GenericStructuredOutput, StructuredOutputAgent
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/src/haive/agents/structured/__init__.py", line 3, in <module>
        from structured.prompts import create_contextual_prompt, get_prompt_for_model
    ModuleNotFoundError: No module named 'structured'
...
.. _sphx_glr_download_auto_examples_agents_structured_output_example.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: structured_output_example.ipynb <structured_output_example.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: structured_output_example.py <structured_output_example.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: structured_output_example.zip <structured_output_example.zip>`
