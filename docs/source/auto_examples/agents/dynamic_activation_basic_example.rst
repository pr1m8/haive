...
.. "auto_examples/agents/dynamic_activation_basic_example.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_agents_dynamic_activation_basic_example.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_agents_dynamic_activation_basic_example.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 14-629
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/examples/dynamic_activation_basic_example.py", line 23, in <module>
        from haive.agents.react.dynamic_react_agent import DynamicReactAgent
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/src/haive/agents/react/dynamic_react_agent.py", line 22, in <module>
        from haive.agents.discovery.component_discovery_agent import ComponentDiscoveryAgent
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/src/haive/agents/discovery/__init__.py", line 6, in <module>
        from haive.agents.discovery.dynamic_tool_selector import (
      File "/home/will/Projects/haive/backend/haive/packages/haive-agents/src/haive/agents/discovery/dynamic_tool_selector.py", line 22, in <module>
        from haive.core.registry import (
    ImportError: cannot import name 'ComponentMetadata' from 'haive.core.registry' (/home/will/Projects/haive/backend/haive/packages/haive-core/src/haive/core/registry/__init__.py)
...
.. _sphx_glr_download_auto_examples_agents_dynamic_activation_basic_example.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: dynamic_activation_basic_example.ipynb <dynamic_activation_basic_example.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: dynamic_activation_basic_example.py <dynamic_activation_basic_example.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: dynamic_activation_basic_example.zip <dynamic_activation_basic_example.zip>`
