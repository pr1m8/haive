...
class DynamicGraphTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.retriever_engine = MockEngine(
            name="retriever_engine", engine_type="retriever"
        )
    ...
    def test_init_with_state_schema(self):
        ...
        graph = MockDynamicGraph(
            name="test_graph", state_schema=TestStateModel, visualize=False
        )
    ...
    def test_to_dict(self):
        ...
        assert result["visualize"] is True
