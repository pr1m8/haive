    ...
    def _create_agentic_prompt() -> ChatPromptTemplate:
        ...
        return ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    """You are an intelligent assistant that can decide when to retrieve information.
    ...
    def _create_grading_prompt() -> ChatPromptTemplate:
        ...
        return ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    """You are a document relevance grader. Assess whether retrieved documents are relevant to the user question.
    ...
    def _create_rewriting_prompt() -> ChatPromptTemplate:
        ...
        return ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    """You are a query rewriting expert. Improve queries to get better retrieval results.
