...
def integrate_extensions():
    ...
    log_message(f"Currently have {len(current_extensions)} extensions configured")
    ...
    results = {
        "working_extensions": working_extensions,
        "failed_extensions": [(pkg, imp, err) for pkg, imp, err in failed_extensions],
        "new_extensions": new_extensions,
        "current_extensions": list(current_extensions),
        "total_packages": len(packages),
        "sphinx_packages": len(sphinx_packages),
    }
