...
DebateFormat: TypeAlias = Literal["traditional", "oxford", "parliamentary", "lincoln-douglas", "policy"]
DebatePhase: TypeAlias = Literal["opening", "arguments", "cross_exam", "rebuttals", "closing", "judging"]
...
def validate_debate_participants(
    ...
    names = [getattr(p, 'name', f'participant_{i}') for i, p in enumerate(all_participants)]
