...
def test_base_class_selection():
    ...
    assert issubclass(ToolState, MessagesStateWithTokenUsage), "ToolState should inherit from MessagesStateWithTokenUsage"
    assert issubclass(MessagesStateWithTokenUsage, StateSchema), "MessagesStateWithTokenUsage should inherit from StateSchema"
