...
def test_field_naming():
    ...
    print(f"camel_to_snake_case('QueryRefinementResponse'): {camel_to_snake_case('QueryRefinementResponse')}")
    ...
    print(f"create_field_name_from_model(QueryRefinementResponse): {create_field_name_from_model(QueryRefinementResponse)}")
    print(f"create_field_name_from_model(QueryRefinementResponse, remove_suffixes=False): {create_field_name_from_model(QueryRefinementResponse, remove_suffixes=False)}")
    
    # Test get_field_info_from_model
    print(f"get_field_info_from_model(QueryRefinementResponse): {get_field_info_from_model(QueryRefinementResponse)}")
    print(f"get_field_info_from_model(CustomQueryResult): {get_field_info_from_model(CustomQueryResult)}")
