...
def test_game_state_initialization():
    ...
    try:
        ...
        results["mastermind_direct"] = {
            "method": "MastermindState()",
            "status": "✅ Works",
        }
    except Exception as e:
        results["mastermind_direct"] = {
    ...
    try:
        ...
        results["mastermind_initialize"] = {
            "method": "MastermindState.initialize()",
            "status": "✅ Works",
        }
    except Exception as e:
        results["mastermind_initialize"] = {
    ...
    try:
        ...
        results["connect4_initialize"] = {
            "method": "Connect4State.initialize()",
            "status": "✅ Works",
        }
    except Exception as e:
        results["connect4_initialize"] = {
