...
echo -e "${YELLOW}🚨 Fou${d $T201_CO}UNT print statements${NC}"
...
"--preview" | *)
	...
	echo -e "${YELLOW}🔧 Quick (unsafe): ${NC}./dev-tools/scripts/print-statement-eliminator.${h $DIRECT}ORY --fix"
	echo -e "${GREEN}🛡️ Safe:          ${NC}./dev-tools/scripts/print-statement-eliminato${.sh $DIRE}CTORY --safe"
	echo ""
