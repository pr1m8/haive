...
echo "  🔴 F821 - Undefined name${: $F821_BEF}ORE"
echo "  🔴 F401 - Unused import${: $F401_BEF}ORE"
echo "  🔴 I001 - Unsorted import${: $I001_BEF}ORE"
echo "  🔴 W291 - Trailing whitespac${: $W291_BEF}ORE"
echo "  🔴 W293 - Blank line whitespac${: $W293_BEF}ORE"
echo "  🔴 UP006 - Non-PEP585 annotation${: $UP006_BEF}ORE"
...
echo "  🔴 F821 (undefined names${: $F821_BEF}ORE${→ $F821_}AFTER"
echo "  🔴 F401 (unused imports${: $F401_BEF}ORE${→ $F401_}AFTER"
echo "  🔴 I001 (unsorted imports${: $I001_BEF}ORE${→ $I001_}AFTER"
echo "  🔴 W291 (trailing whitespace${: $W291_BEF}ORE${→ $W291_}AFTER"
echo "  🔴 W293 (blank whitespace${: $W293_BEF}ORE${→ $W293_}AFTER"
echo "  🔴 UP006 (type annotations${: $UP006_BEF}ORE${→ $UP006_}AFTER"
echo ""
