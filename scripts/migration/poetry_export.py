...
class HaiveDependencyManager:
    ...
    def load_root_pyproject(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Failed to load root pyproject.toml: {e}")
            return {}
    ...
    def export_dev_dependencies_to_core(self, root_pyproject: Dict[str, Any]):
        ...
        try:
            ...
            core_pyproject = toml.load(core_pyproject_path) if core_pyproject_path.exists() else {}
            ...
            logger.error(f"Failed to export dev dependencies: {e}")
    ...
    def _extract_toolkit_dependencies(self, root_pyproject: Dict[str, Any]) -> Dict[str, Dict[str, Any]]:
        """
        ...
        for group_name, group_data in groups.items():
            ...
            if target_package and 'dependencies' in group_data:
                toolkit_distribution[target_package][group_name] = group_data['dependencies']
