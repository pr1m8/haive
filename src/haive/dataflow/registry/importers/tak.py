...
def get_or_create_tool(name: str, category_id: str, display_name: Optional[str] = None, description: Optional[str] = None) -> str:
        ...
        try:
            ...
            if "toolkit" in tool_type or (tool_module and "toolkits" in tool_module):
                ...
                if "toolkits" in tool_module:
                    ...
                    toolkit_index = parts.index("toolkits") if "toolkits" in parts else -1
...
def main():
    ...
    tools_from_toolkits = load_tools_from_directory(TOOLKITS_PATH, "haive.toolkits", "toolkit")
