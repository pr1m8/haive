...
Example:
    >>> from src.haive.agents.agent_games.framework.multi_player import MultiPlayerGameAgent
    >>> from src.haive.agents.agent_games.framework.multi_player import MultiPlayerGameConfig
    >>> 
