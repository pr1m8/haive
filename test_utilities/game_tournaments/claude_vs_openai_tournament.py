...
def create_claude_openai_config(game_config_class, claude_player: str, openai_player: str):
    ...
    if hasattr(config, 'engines') and isinstance(config.engines, dict):
        ...
        for engine_name, engine_config in engines.items():
            if claude_player in engine_name.lower() or 'player1' in engine_name.lower() or 'x' in engine_name.lower() or 'white' in engine_name.lower():
                # Assign Claude
            ...
            elif openai_player in engine_name.lower() or 'player2' in engine_name.lower() or 'o' in engine_name.lower() or 'black' in engine_name.lower():
                # Assign OpenAI
                if hasattr(engine_config, 'model'):
...
def main():
    ...
    print("🏟️ CLAUDE vs OPENAI TOURNAMENT")
    print("================================")
