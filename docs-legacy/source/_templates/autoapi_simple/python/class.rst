...
.. py:class:: {{ obj.short_name }}{% if obj.args %}({{ obj.args }}){% endif %}
   ...
   * :py:meth:`~{{ obj.name }}.__init__` - Initialize the {{ obj.short_name }}
   {% endfor %}
   {% for method in regular_methods %}
   * :py:meth:`~{{ obj.name }}.{{ method.short_name }}` - {{ method.summary|default("Method " + method.short_name, true) }}
   {% endfor %}
   {% endif %}
   {% endblock %}
   ...
   * :py:attr:`~{{ obj.name }}.{{ attribute.short_name }}` - {{ attribute.summary|default("Attribute " + attribute.short_name, true) }}
   {% endfor %}
   {% endif %}
   {% endblock %}
   ...
   * :py:class:`{{ obj.name }}.{{ class.short_name }}` - {{ class.summary|default("Inner class " + class.short_name, true) }}
   {% endfor %}
   {% endif %}
   {% endblock %}
