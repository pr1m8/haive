"""Minimal Furo configuration with AutoAPI - no autosummary conflicts."""
...
# Use clean index without autosummary references
master_doc = "index_furo_clean"

# =============================================================================
# MINIMAL EXTENSIONS - NO AUTOSUMMARY CONFLICTS
# =============================================================================
...
extensions = [
    ...
    # Enhanced documentation - SAFE EXTENSIONS ONLY
    "sphinx_copybutton",
    "myst_parser",
    "sphinx_design",
    
    # NOTE: These extensions cause autosummary conflicts:
    # - sphinx.ext.autosummary (obvious)
    # - sphinx_automodapi.automodapi (uses autosummary internally)
    # - sphinx.ext.autodoc (can trigger autosummary)
    # - sphinx_autodoc_typehints (may trigger autosummary)
]
...
# Ensure no autosummary is generated
autosummary_generate = False

# Disable autodoc completely to prevent any autosummary triggers
