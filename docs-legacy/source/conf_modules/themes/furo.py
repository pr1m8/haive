...
def _get_theme_options(
    ...
    options = {
        ...
        # === CSS VARIABLES ===
        "light_css_variables": _get_light_css_variables(sidebar_width, content_width),
        "dark_css_variables": _get_dark_css_variables(),
        # === PYGMENTS ===
        "pygments_light_style": "default",
        "pygments_dark_style": "github-dark",
        # === SOURCE REPOSITORY ===
        "source_repository": github_url or "https://github.com/will-astley/haive",
        "source_branch": "main",
