# Single_Player Agent Examples

Real examples and outputs from the single_player agent.

## single_player_README

**Source**: `packages/haive-games/src/haive/games/single_player/README.md`
...
For detailed API documentation, see the [API Reference](../../../docs/source/api/single_player/index.rst).

## See Also

- [`single_player.rubiks`](./rubiks/): TODO: Add description
