...
def test_state_schema_methods():
    ...
    try:
        ...
        methods_to_test = [
            'model_dump', 'to_dict', 'to_json', 'from_dict', 'from_json',
            'get_engine', 'get_engines', 'has_engine', 'sync_engine_fields',
            'add_message', 'get_last_message', 'copy', 'deep_copy',
            'pretty_print', 'display_schema', 'as_table'
        ]
...
def test_schema_composer_methods():
    ...
    try:
        ...
        # Test core methods exist
        methods_to_test = [
            'add_field', 'add_engine', 'add_fields_from_components',
            'add_fields_from_model', 'add_fields_from_engine', 
            'add_engine_management', 'build', 'from_components'
        ]
...
def test_messages_state_methods():
    ...
    try:
        ...
        # Test core methods exist
        methods_to_test = [
            'add_message', 'get_last_message', 'add_system_message',
            'get_system_message', 'get_filtered_messages', 
            'has_tool_calls', 'get_tool_calls', 'to_openai_format',
...
def test_token_usage_functionality():
    ...
    try:
        from haive.core.schema.prebuilt.messages import (
            TokenUsage, TokenUsageMixin, MessagesStateWithTokenUsage
        )
