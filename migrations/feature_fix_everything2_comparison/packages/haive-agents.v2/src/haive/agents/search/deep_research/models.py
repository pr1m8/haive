...
class ResearchSection(BaseModel):
    ...
    sources: list[ResearchSource] = Field(
        ...
        description="Sources for this section",
    )
    key_points: list[str] = Field(
        default_factory=list,
        description="Key points from this section",
    )
...
class DeepResearchResponse(SearchResponse):
    ...
    related_topics: list[str] = Field(
        default_factory=list,
        description="Related topics discovered",
    )
...
class DeepResearchRequest(BaseModel):
    ...
    time_period: str | None = Field(
        default=None,
        description="Time period for sources (e.g., 'last_5_years')",
    )
