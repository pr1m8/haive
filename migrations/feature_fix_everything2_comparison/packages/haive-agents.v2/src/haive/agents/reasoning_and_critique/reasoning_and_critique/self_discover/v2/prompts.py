...
structured_prompt = ChatPromptTemplate.from_messages([(
    'system', """You are an expert at creating structured reasoning plans.
...
Create a JSON structure that defines the reasoning steps without actually solving the problem.""", ), ('human', """Operationalize the reasoning modules into a step-by-step reasoning plan in JSON format:
