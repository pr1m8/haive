...
class RAGChainCollection:
    ...
    @staticmethod
    def create_hyde_rag(documents: list[Document],
                        llm_config: LLMConfig) -> ChainAgent:
        ...
        return ChainAgent(hyde_generator,
                          enhanced_retrieve,
                          answerer,
                          name='HyDE RAG')
    ...
    def create_fusion_rag(
        ...
        return ChainAgent(multi_query_gen,
                          fusion_rank,
                          synthesizer,
                          name='Fusion RAG')
    ...
    def create_speculative_rag(
        ...
        hypothesis_gen = AugLLMConfig(
            ...
            prompt_template=ChatPromptTemplate.from_messages([
                ('system',
                 'Generate 3 hypotheses that could answer this query'),
                ('human', '{query}'),
            ], ),
        ...
        def verify_hypotheses(state: dict[str, Any]) -> dict[str, Any]:
            ...
            for hypothesis in hypotheses[:2]:  # Verify first 2
                ...
                if any(key in doc.page_content.lower() for doc in documents
    ...
    def create_memory_aware_rag(
        ...
        def analyze_memory(state: dict[str, Any]) -> dict[str, Any]:
            ...
            past_topics = ['AI', 'machine learning'
    ...
    def create_flare_rag(
        ...
        def active_retrieve(state: dict[str, Any]) -> dict[str, Any]:
            ...
            needs_more_info = ('need' in initial_answer.lower()
                               or 'unclear' in initial_answer.lower())
