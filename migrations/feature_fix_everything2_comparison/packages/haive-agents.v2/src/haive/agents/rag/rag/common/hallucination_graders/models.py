...
class HallucinationClaim(BaseModel):
    ...
    is_supported: bool = Field(
        description='Whether the claim is supported by sources')
...
class HallucinationDetectionResponse(BaseModel):
    ...
    generated_answer: str = Field(
        description='The AI-generated answer being evaluated')
    ...
    supported_claims: list[str] = Field(
        description='Claims well-supported by sources')
    unsupported_claims: list[str] = Field(
        description='Claims lacking source support')
...
class HallucinationBinaryResponse(BaseModel):
    ...
    severity_level: Literal[
        'none', 'minor', 'moderate', 'major', 'severe'] = Field(
