...
class ProjectAsset(BaseModel):
    ...
    content: str | None = Field(default=None,
                                description='Asset content or code')
...
class WorkflowStep(BaseModel):
    ...
    tool_used: str | None = Field(default=None,
                                  description='Tool used for this step')
...
class InteractiveApp(BaseModel):
    ...
    javascript_code: str | None = Field(default=None,
...
class LabsResponse(SearchResponse):
    ...
    search_type: str = Field(default='Labs',
    ...
    project_summary: str = Field(default='',
                                 description='Summary of project work')
    ...
    class Config:
        ...
        json_schema_extra = {
            'example': {
                'query':
                'Create a dashboard analyzing customer satisfaction survey data',
                'response':
                "# Customer Satisfaction Dashboard Project\n\nI've created a comprehensive dashboard analyzing your customer satisfaction survey data...",
                ...
                'workflow_steps': [
                    {
                        ...
                        'description':
                        'Load and validate customer survey data',
                        'tool_used': 'pandas',
                        'input_data': {
                ...
                'assets_created': [
                    {
                        ...
                        'type': 'dashboard',
                        'description':
                        'Interactive dashboard showing satisfaction metrics',
                ...
                'interactive_apps': [
                    {
                        ...
                        'description':
                        'Interactive app for exploring satisfaction data',
                        'app_type': 'dashboard',
                ...
                5,
                'project_summary':
                'Created an interactive dashboard with 5 visualizations analyzing customer satisfaction survey data from 1,250 responses.',
                'next_steps': [
...
class LabsRequest(BaseModel):
    ...
    max_work_time: int = Field(default=600,
                               description='Maximum work time in seconds')
    ...
    class Config:
        ...
        json_schema_extra = {
            'example': {
                'query':
                'Analyze sales data and create interactive charts showing trends',
