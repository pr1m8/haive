...
This example demonstrates how to create a simple dynamic supervisor that
can route tasks to different specialized agents.
"""
...
async def main():
    ...
    state.add_agent('math_agent', math_agent,
                    'Expert at mathematical calculations')
    state.add_agent('general_agent', general_agent,
