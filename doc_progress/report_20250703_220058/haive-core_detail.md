...
- **Type Signature Issues**: 518
- **Pydantic Field Issues**: 294
- **Has Main **init**.py**: ❌
- **Has README**: ✅
- **Has Examples**: ✅
- **Total Issues**: 2308
...
### src/haive/core/models/retriever/factory.py

- 🔵 **Line 349**: Function 'list_available_providers' missing type hints
- 🔵 **Line 1**: Function 'RetrieverFactory.\_get_provider_package_info' parameter 'provider' name doesn't match type hint
...
### src/haive/core/models/retriever/providers/bm25.py

- 🔵 **Line 159**: Method 'Bm25Provider.instantiate' missing type hints
- 🔵 **Line 212**: Method 'Bm25Provider.get_bm25_params' missing type hints
- 🔵 **Line 223**: Method 'Bm25Provider.get_corpus_info' missing type hints
- 🔵 **Line 1**: Function 'Bm25Provider.instantiate' returns overly generic type 'Any'

### src/haive/core/models/retriever/providers/base.py

- 🔵 **Line 121**: Method 'BaseRetrieverProvider.instantiate' missing type hints
- 🔵 **Line 218**: Method 'BaseRetrieverProvider.get_config_dict' missing type hints
- 🔵 **Line 226**: Method 'BaseRetrieverProvider.validate_config' missing type hints

### src/haive/core/models/retriever/providers/multi_query.py

- 🔵 **Line 163**: Method 'MultiQueryProvider.get_query_generation_params' missing type hints

### src/haive/core/models/retriever/providers/**init**.py

- 🟡 **Line 1**: **init**.py missing **all** definition
- 🔵 **Line 129**: Function 'list_providers' missing type hints
- 🔵 **Line 146**: Function 'get_available_providers' missing type hints
- 🔵 **Line 1**: Function 'get_provider' parameter 'provider_type' name doesn't match type hint
- 🔵 **Line 1**: Function 'register_provider' parameter 'provider_type' name doesn't match type hint

### src/haive/core/models/retriever/providers/vector_store.py

- 🔵 **Line 173**: Method 'VectorStoreProvider.get_search_params' missing type hints

### src/haive/core/models/retriever/providers/ensemble.py

- 🔵 **Line 90**: Method 'EnsembleProvider.validate_weights' missing type hints
- 🔵 **Line 105**: Method 'EnsembleProvider.validate_retrievers' missing type hints
- 🔵 **Line 149**: Method 'EnsembleProvider.get_ensemble_info' missing type hints
- 🔵 **Line 1**: Function 'EnsembleProvider.add_retriever' uses overly generic type 'Any' for parameter 'retriever'
