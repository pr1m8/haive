...
- **Type Signature Issues**: 218
- **Pydantic Field Issues**: 235
- **Has Main **init**.py**: ❌
- **Has README**: ✅
- **Has Examples**: ✅
- **Total Issues**: 1706
...
- 🔵 **Line 1**: Function 'StateWrapper.store_object' uses overly generic type 'Any' for parameter 'obj'
- 🔵 **Line 1**: Function 'StateWrapper.get_object' returns overly generic type 'Any'
...
- 🔵 **Line 1**: Function 'ChainAgent.\_prepare_input' returns overly generic type 'Any'
...
- 🔵 **Line 1**: Function 'GenericAgent.\_extract_generic_types' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'Agent.invoke' uses overly generic type 'Any' for parameter 'input_data'
- 🔵 **Line 1**: Function 'Agent.invoke' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'Agent.**getattr**' returns overly generic type 'Any'

### src/haive/agents/base/simple_agent_base.py

- 🔵 **Line 74**: Method 'Agent.validate_agent_requirements' missing type hints
- 🔵 **Line 164**: Method 'Agent.get_available_tools' missing type hints
- 🔵 **Line 173**: Method 'Agent.can_reason' missing type hints
- 🔵 **Line 177**: Method 'Agent.get_agent_capabilities' missing type hints
- 🔵 **Line 188**: Method 'Agent.get_node_type' missing type hints
- 🔵 **Line 193**: Method 'Agent.setup_agent' missing type hints
- 🔵 **Line 1**: Function 'Agent.reason' uses overly generic type 'Any' for parameter 'problem'
- 🔵 **Line 1**: Function 'Agent.reason' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'Agent.use_tool' returns overly generic type 'Any'
...
- 🔵 **Line 1**: Function 'AgentDebugger.log_recursion_limit_flow' uses overly generic type 'Any' for parameter 'recursion_limit'
- 🔵 **Line 1**: Function 'AgentDebugger.log_agent_execution_start' uses overly generic type 'Any' for parameter 'input_data'
...
- 🔵 **Line 1**: Function 'CompiledAgent.reason' uses overly generic type 'Any' for parameter 'problem'
- 🔵 **Line 1**: Function 'CompiledAgent.reason' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'CompiledAgent.use_tool' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'CompiledAgent.invoke' uses overly generic type 'Any' for parameter 'input_data'
- 🔵 **Line 1**: Function 'CompiledAgent.invoke' returns overly generic type 'Any'

### src/haive/agents/base/agent_with_token_tracking.py

- 🔵 **Line 130**: Method 'TokenTrackingAgent.get_token_usage_summary' missing type hints
- 🔵 **Line 145**: Method 'TokenTrackingAgent.calculate_conversation_costs' missing type hints
- 🔵 **Line 1**: Function 'TokenTrackingAgent.\_setup_schemas' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 702**: Method 'Agent.get_input_fields' missing type hints
- 🔵 **Line 725**: Method 'Agent.get_output_fields' missing type hints
- 🔵 **Line 829**: Method 'Agent.main_engine' missing type hints
- 🔵 **Line 851**: Method 'Agent.build_graph' missing type hints
- 🔵 **Line 864**: Method 'Agent.rebuild_graph' missing type hints
- 🔵 **Line 875**: Method 'Agent.regenerate_schemas' missing type hints
- 🔵 **Line 885**: Method 'Agent.compile' missing type hints
- 🔵 **Line 1023**: Method 'Agent.get_all_tools' missing type hints
- 🔵 **Line 1072**: Method 'Agent.get_all_tool_schemas' missing type hints
- 🔵 **Line 1148**: Method 'Agent.get_all_class_engines' missing type hints
- 🔵 **Line 1181**: Method 'Agent.get_all_instance_engines' missing type hints
- 🔵 **Line 1273**: Method 'Agent.get_state_tools' missing type hints
- 🔵 **Line 1292**: Method 'Agent.sync_tools_to_engines' missing type hints
- 🔵 **Line 1310**: Method 'Agent.get_schema_info' missing type hints
- 🔵 **Line 1390**: Method 'Agent.display_schema_info' missing type hints
- 🔵 **Line 1505**: Method 'Agent.auto_derive_schemas' missing type hints
- 🔵 **Line 1524**: Method 'Agent.get_derived_schemas' missing type hints
- 🔵 **Line 1**: Function 'Agent.\_setup_schemas' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'Agent.\_auto_derive_io_schemas' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'Agent.main_engine' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'Agent.invoke' uses overly generic type 'Any' for parameter 'input_data'
- 🔵 **Line 1**: Function 'Agent.invoke' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'Agent.visualize_graph' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'Agent.get_class_engine' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'Agent.get_instance_engine' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'Agent.add_tool_to_state' uses overly generic type 'Any' for parameter 'tool'
- 🔵 **Line 1**: Function 'Agent.derive_input_schema' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'Agent.derive_output_schema' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'GraphProvider.build_graph' returns overly generic type 'Any'

### src/haive/agents/document/agent.py

- 🔵 **Line 406**: Method 'DocumentAgent.validate_engine_type' missing type hints
- 🔵 **Line 414**: Method 'DocumentAgent.validate_chunk_overlap' missing type hints
- 🔵 **Line 422**: Method 'DocumentAgent.setup_agent' missing type hints
- 🔵 **Line 496**: Method 'DocumentAgent.build_graph' missing type hints
- 🔵 **Line 1**: Function 'DocumentAgent.\_register_engine_in_registry' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'DocumentAgent.\_sync_configuration_to_engine' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'create_context_aware_selector' parameter 'min_confidence' name doesn't match type hint
...
- 🔵 **Line 1**: Function 'CapabilityMatcher.\_infer_capabilities' uses overly generic type 'Any' for parameter 'tool'
...
### src/haive/agents/supervisor/test_with_registry.py

- 🔵 **Line 119**: Method 'TestAgentRegistry.get_agent' missing type hints
- 🔵 **Line 123**: Method 'TestAgentRegistry.get_config' missing type hints
- 🔵 **Line 127**: Method 'TestAgentRegistry.get_all_agents' missing type hints

### src/haive/agents/supervisor/test_compatibility.py

- 🔵 **Line 64**: Method 'MockMultiAgent.setup_agent' missing type hints
- 🔵 **Line 68**: Method 'MockMultiAgent.build_graph' missing type hints
- 🟡 **Line 28**: Class 'MockResponse' missing docstring
- 🟡 **Line 43**: Class 'MockResult' missing docstring
- 🟡 **Line 47**: Class 'MockMessage' missing docstring
- 🟡 **Line 113**: Class 'MockDynamicSupervisor' missing docstring
- 🔵 **Line 135**: Method 'MockDynamicSupervisor.get_dynamic_status' missing docstring
- 🔵 **Line 135**: Method 'MockDynamicSupervisor.get_dynamic_status' missing type hints
- 🟡 **Line 245**: Class 'MockReactAgent' missing docstring
- 🟡 **Line 298**: Class 'CompatibilityBridge' missing docstring
- 🔵 **Line 303**: Method 'CompatibilityBridge.migrate_to_dynamic' missing type hints
- 🔵 **Line 314**: Method 'CompatibilityBridge.verify_compatibility' missing type hints

### src/haive/agents/supervisor/dynamic_multi_agent.py

- 🔵 **Line 53**: Method 'DynamicMultiAgent.setup_agent' missing type hints
- 🔵 **Line 165**: Method 'DynamicMultiAgent.build_graph' missing type hints
- 🔵 **Line 543**: Method 'DynamicMultiAgent.get_agent_capabilities' missing type hints
- 🔵 **Line 1**: Function 'DynamicMultiAgent.\_extract_state_dict' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'DynamicMultiAgent.\_process_agent_result' uses overly generic type 'Any' for parameter 'result'
- 🔵 **Line 1**: Function 'DynamicMultiAgent.\_route_from_supervisor' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'DynamicMultiAgent.\_update_performance_metrics' might return None but type signature doesn't indicate Optional

### src/haive/agents/supervisor/example_dynamic_supervisor.py

- 🟡 **Line 237**: Class 'MockTool' missing docstring

### src/haive/agents/supervisor/compatibility_bridge.py

- 🔵 **Line 55**: Method 'DynamicMultiAgentSupervisor.setup_dynamic_supervisor' missing type hints
- 🔵 **Line 76**: Method 'DynamicMultiAgentSupervisor.setup_agent' missing type hints
- 🔵 **Line 146**: Method 'DynamicMultiAgentSupervisor.build_graph' missing type hints
- 🔵 **Line 319**: Method 'DynamicMultiAgentSupervisor.get_dynamic_status' missing type hints
- 🔵 **Line 348**: Method 'ReactMultiAgentSupervisor.build_graph' missing type hints
- 🔵 **Line 1**: Function 'DynamicMultiAgentSupervisor.\_create_dynamic_supervisor_node' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'DynamicMultiAgentSupervisor.\_create_managed_agent_node' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'DynamicMultiAgentSupervisor.\_create_dynamic_management_node' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'create_compatible_supervisor' uses overly generic type 'Any' for parameter 'supervisor_engine'

### src/haive/agents/supervisor/dynamic_state.py

- 🔵 **Line 158**: Method 'DynamicSupervisorState.active_agent_count' missing type hints
- 🔵 **Line 164**: Method 'DynamicSupervisorState.last_execution_time' missing type hints
- 🔵 **Line 172**: Method 'DynamicSupervisorState.success_rate' missing type hints
- 🔵 **Line 181**: Method 'DynamicSupervisorState.most_used_agent' missing type hints
- 🔵 **Line 287**: Method 'DynamicSupervisorState.get_available_agents' missing type hints
- 🔵 **Line 291**: Method 'DynamicSupervisorState.get_high_priority_agents' missing type hints
- 🔵 **Line 1**: Function 'DynamicSupervisorState.adapt_response_for_agent' uses overly generic type 'Any' for parameter 'response'
- 🔵 **Line 1**: Function 'DynamicSupervisorState.adapt_response_for_agent' returns overly generic type 'Any'

### src/haive/agents/supervisor/dynamic_supervisor_fixed.py

- 🔵 **Line 104**: Method 'DynamicSupervisorFixed.build_graph' missing type hints
- 🔵 **Line 294**: Method 'DynamicSupervisorFixed.get_registered_agents' missing type hints
- 🟡 **Line 316**: Class 'MockAgent' missing docstring
- 🔵 **Line 1**: Function 'DynamicSupervisorFixed.register_agent' uses overly generic type 'Any' for parameter 'agent'
- 🔵 **Line 1**: Function 'DynamicSupervisorFixed.invoke' uses overly generic type 'Any' for parameter 'input'
- 🔵 **Line 1**: Function 'DynamicSupervisorFixed.invoke' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'DynamicSupervisorFixed.\_create_agent_wrapper' uses overly generic type 'Any' for parameter 'agent'

### src/haive/agents/supervisor/internal_dynamic_supervisor.py

- 🔵 **Line 49**: Method 'InternalDynamicSupervisor.setup_agent' missing type hints
- 🔵 **Line 94**: Method 'InternalDynamicSupervisor.build_graph' missing type hints
- 🔵 **Line 436**: Method 'InternalDynamicSupervisor.get_creation_history' missing type hints
- 🔵 **Line 440**: Method 'InternalDynamicSupervisor.get_available_templates' missing type hints
- 🔵 **Line 1**: Function 'InternalDynamicSupervisor.\_extract_state_dict' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'InternalDynamicSupervisor.\_route_from_supervisor' uses overly generic type 'Any' for parameter 'state'

### src/haive/agents/supervisor/choice_model_supervisor.py

- 🔵 **Line 173**: Method 'ChoiceModelSupervisor.setup_agent' missing type hints
- 🔵 **Line 198**: Method 'ChoiceModelSupervisor.agents' missing type hints
- 🔵 **Line 222**: Method 'ChoiceModelSupervisor.build_graph' missing type hints
- 🔵 **Line 446**: Method 'ChoiceModelSupervisor.get_available_agents' missing type hints
- 🔵 **Line 450**: Method 'ChoiceModelSupervisor.get_choice_model_status' missing type hints
- 🔵 **Line 1**: Function 'ChoiceModelSupervisor.\_extract_state_dict' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'ChoiceModelSupervisor.\_route_from_supervisor' uses overly generic type 'Any' for parameter 'state'

### src/haive/agents/supervisor/test_registry_demo.py

- 🔵 **Line 100**: Method 'MockRegistrySupervisor.populate_registry' missing type hints
- 🔵 **Line 206**: Method 'MockRegistrySupervisor.get_status' missing type hints
- 🔵 **Line 1**: Function 'MockRegistrySupervisor.\_select_from_active' might return None but type signature doesn't indicate Optional

### src/haive/agents/supervisor/integrated_supervisor.py

- 🔵 **Line 101**: Method 'IntegratedDynamicSupervisor.register_agent_constructor' missing type hints
- 🔵 **Line 163**: Method 'IntegratedDynamicSupervisor.build_graph' missing type hints
- 🔵 **Line 434**: Method 'IntegratedDynamicSupervisor.end_coordination_session' missing type hints
- 🔵 **Line 440**: Method 'IntegratedDynamicSupervisor.get_coordination_status' missing type hints
- 🔵 **Line 446**: Method 'IntegratedDynamicSupervisor.print_integrated_dashboard' missing type hints
- 🔵 **Line 1**: Function 'IntegratedDynamicSupervisor.\_create_integrated_supervisor_node' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'IntegratedDynamicSupervisor.\_create_agent_management_node' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'IntegratedDynamicSupervisor.\_create_enhanced_coordinator_node' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'IntegratedDynamicSupervisor.print_integrated_dashboard' might return None but type signature doesn't indicate Optional

### src/haive/agents/supervisor/dynamic_agent_tools.py

- 🔵 **Line 75**: Method 'AgentRegistryManager.register_agent_constructor' missing type hints
- 🔵 **Line 101**: Method 'AgentRegistryManager.get_agent_choice_model' missing type hints
- 🔵 **Line 314**: Function 'create_agent_management_tools' missing type hints
- 🔵 **Line 341**: Function 'register_agent_constructor' missing type hints
...
### src/haive/agents/supervisor/test_advanced_prebuilt.py

- 🔵 **Line 192**: Method 'AgentPool.add_agent' missing type hints
- 🔵 **Line 226**: Method 'AgentPool.get_active_agents' missing type hints

### src/haive/agents/supervisor/dynamic_executor_node.py

- 🔵 **Line 1**: Function 'DynamicExecutorNode.\_prepare_agent_input' uses overly generic type 'Any' for parameter 'agent'
- 🔵 **Line 1**: Function 'DynamicExecutorNode.\_process_agent_result' uses overly generic type 'Any' for parameter 'result'

### src/haive/agents/supervisor/proper_dynamic_supervisor.py

- 🔵 **Line 89**: Method 'ProperDynamicSupervisor.build_graph' missing type hints
- 🔵 **Line 259**: Method 'ProperDynamicSupervisor.get_registered_agents' missing type hints
- 🔵 **Line 263**: Method 'ProperDynamicSupervisor.get_agent_capabilities' missing type hints
- 🔵 **Line 1**: Function 'ProperDynamicSupervisor.register_agent' uses overly generic type 'Any' for parameter 'agent'

### src/haive/agents/supervisor/test_post_compile_addition.py

- 🔵 **Line 100**: Method 'SimpleDynamicSupervisor.compile' missing type hints
- 🔵 **Line 106**: Method 'SimpleDynamicSupervisor.can_add_agents_post_compile' missing type hints
- 🟡 **Line 207**: Class 'GraphRebuildingSupervisor' missing docstring
- 🟡 **Line 33**: Class 'MockResponse' missing docstring
- 🟡 **Line 50**: Class 'MockResult' missing docstring
- 🟡 **Line 54**: Class 'MockMessage' missing docstring
...
- 🔵 **Line 278**: Method 'DynamicSupervisorAgent.build_graph' missing type hints
- 🔵 **Line 803**: Method 'DynamicSupervisorAgent.get_performance_summary' missing type hints
- 🔵 **Line 826**: Method 'DynamicSupervisorAgent.print_supervisor_dashboard' missing type hints
- 🔵 **Line 901**: Method 'PerformanceMonitor.start_decision' missing docstring
- 🔵 **Line 901**: Method 'PerformanceMonitor.start_decision' missing type hints
- 🔵 **Line 904**: Method 'PerformanceMonitor.end_decision' missing docstring
- 🔵 **Line 904**: Method 'PerformanceMonitor.end_decision' missing type hints
- 🔵 **Line 911**: Method 'PerformanceMonitor.get_average_decision_time' missing docstring
- 🔵 **Line 911**: Method 'PerformanceMonitor.get_average_decision_time' missing type hints
- 🔵 **Line 1**: Function 'DynamicSupervisorAgent.\_update_supervisor_tools' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'DynamicSupervisorAgent.\_parse_decision_response' uses overly generic type 'Any' for parameter 'response'
- 🔵 **Line 1**: Function 'DynamicSupervisorAgent.\_prepare_enhanced_agent_state' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'DynamicSupervisorAgent.print_supervisor_dashboard' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'SupervisorAgent.\_prepare_agent_state' returns overly generic type 'Any'

### src/haive/agents/supervisor/simple_test_runner.py

- 🔵 **Line 217**: Method 'SimpleDynamicSupervisorTest.print_status' missing type hints
- 🟡 **Line 27**: Class 'MockResponse' missing docstring
- 🟡 **Line 66**: Class 'MockResult' missing docstring
- 🟡 **Line 74**: Class 'MockMessage' missing docstring

### src/haive/agents/supervisor/multi_agent_dynamic_state.py

- 🔵 **Line 306**: Method 'MultiAgentDynamicSupervisorState.total_registered_agents' missing type hints
- 🔵 **Line 312**: Method 'MultiAgentDynamicSupervisorState.total_available_tools' missing type hints
- 🔵 **Line 318**: Method 'MultiAgentDynamicSupervisorState.active_coordination_sessions' missing type hints
- 🔵 **Line 365**: Method 'MultiAgentDynamicSupervisorState.process_pending_agent_changes' missing type hints
- 🔵 **Line 424**: Method 'MultiAgentDynamicSupervisorState.end_coordination_session' missing type hints
- 🔵 **Line 439**: Method 'MultiAgentDynamicSupervisorState.get_coordination_status' missing type hints

### src/haive/agents/supervisor/registry_supervisor.py

- 🔵 **Line 27**: Method 'AgentRegistry.register_agent' missing type hints
- 🔵 **Line 37**: Method 'AgentRegistry.get_available_agents' missing type hints
- 🔵 **Line 167**: Method 'RegistrySupervisor.setup_agent' missing type hints
- 🔵 **Line 191**: Method 'RegistrySupervisor.populate_registry' missing type hints
- 🔵 **Line 234**: Method 'RegistrySupervisor.build_graph' missing type hints
- 🔵 **Line 444**: Method 'RegistrySupervisor.get_active_agents' missing type hints
- 🔵 **Line 448**: Method 'RegistrySupervisor.get_registry_agents' missing type hints
- 🔵 **Line 452**: Method 'RegistrySupervisor.get_choice_model_status' missing type hints
- 🔵 **Line 1**: Function 'RegistrySupervisor.\_extract_state_dict' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'RegistrySupervisor.\_route_from_supervisor' uses overly generic type 'Any' for parameter 'state'

### src/haive/agents/supervisor/routing.py

- 🔵 **Line 465**: Method 'DynamicRoutingEngine.print_routing_stats' missing type hints
- 🔵 **Line 1**: Function 'DynamicRoutingEngine.\_extract_context' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'DynamicRoutingEngine.\_create_routing_command' uses overly generic type 'Any' for parameter 'state'
...
### src/haive/agents/supervisor/rebuild_dynamic_supervisor.py

- 🔵 **Line 112**: Method 'RebuildDynamicSupervisor.build_graph' missing type hints
- 🟡 **Line 394**: Class 'TestAgent' missing docstring
- 🔵 **Line 1**: Function 'RebuildDynamicSupervisor.register_agent' uses overly generic type 'Any' for parameter 'agent'
- 🔵 **Line 1**: Function 'RebuildDynamicSupervisor.\_create_agent_node' uses overly generic type 'Any' for parameter 'agent'
- 🔵 **Line 1**: Function 'RebuildDynamicSupervisor.\_prepare_agent_input' uses overly generic type 'Any' for parameter 'agent'
- 🔵 **Line 1**: Function 'RebuildDynamicSupervisor.\_process_agent_result' uses overly generic type 'Any' for parameter 'result'
- 🔵 **Line 1**: Function 'RebuildDynamicSupervisor.\_route_from_supervisor' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'RebuildDynamicSupervisor.invoke' uses overly generic type 'Any' for parameter 'input'
- 🔵 **Line 1**: Function 'RebuildDynamicSupervisor.invoke' returns overly generic type 'Any'
...
- 🔵 **Line 1**: Function 'SequentialAgentConfig.get_step_by_name' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'SimpleAgentState.extract_last_message_content' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'SimpleAgent.\_register_engine_in_registry' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'SimpleAgent.\_sync_fields_to_engine' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'SimpleAgent.\_modify_engine_schema' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'SimpleAgent.create_runnable' returns overly generic type 'Any'

### src/haive/agents/simple/agent_with_validation.py

- 🔵 **Line 29**: Function 'has_tool_calls' missing type hints
- 🔵 **Line 102**: Method 'SimpleAgentWithValidation.validate_engine_type' missing type hints
- 🔵 **Line 108**: Method 'SimpleAgentWithValidation.setup_agent' missing type hints
- 🔵 **Line 274**: Method 'SimpleAgentWithValidation.get_tool_routes' missing type hints
- 🔵 **Line 315**: Method 'SimpleAgentWithValidation.build_graph' missing type hints
- 🔵 **Line 405**: Method 'SimpleAgentWithValidation.create_runnable' missing type hints
- 🔵 **Line 428**: Method 'SimpleAgentWithValidation.from_engine' missing type hints
- 🔵 **Line 433**: Method 'SimpleAgentWithValidation.create_with_tools' missing type hints
- 🔵 **Line 438**: Method 'SimpleAgentWithValidation.create_strict_validation' missing type hints
- 🔵 **Line 448**: Method 'SimpleAgentWithValidation.create_permissive_validation' missing type hints
- 🔵 **Line 1**: Function 'SimpleAgentWithValidation.\_register_engine_in_registry' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'SimpleAgentWithValidation.\_sync_fields_to_engine' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'SimpleAgentWithValidation.\_modify_engine_schema' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'SimpleAgentWithValidation.create_runnable' returns overly generic type 'Any'
...
- 🔵 **Line 1**: Function 'LTMAgent.**init**' parameter 'enable_consolidation' name doesn't match type hint
...
- 🟡 **Line 1**: Module missing docstring
- 🔵 **Line 20**: Method 'ReactAgent.build_graph' missing type hints
...
- 🔵 **Line 1**: Function 'MultiAgent.get_agent_by_name' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'MultiAgent.\_serialize_tool_for_state' uses overly generic type 'Any' for parameter 'tool'
- 🔵 **Line 1**: Function 'MultiAgent.\_serialize_engine_for_state' uses overly generic type 'Any' for parameter 'engine'
- 🔵 **Line 1**: Function 'MultiAgent.\_prepare_input' uses overly generic type 'Any' for parameter 'input_data'
- 🔵 **Line 1**: Function 'MultiAgent.\_prepare_input' returns overly generic type 'Any'
...
- 🔵 **Line 1**: Function 'MultiAgent.\_setup_schemas' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'MultiAgent.\_get_agent_input_mapping' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'MultiAgent.\_get_agent_output_mapping' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'MultiAgent.route_to_agent' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'MultiAgent.should_continue' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'MultiAgent.update_agent_state' returns overly generic type 'Any'
...
- 🔵 **Line 1**: Function 'CompatibilityEnhancedMultiAgent.\_get_agent_output_schema' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'CompatibilityEnhancedMultiAgent.\_get_agent_input_schema' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'CompatibilityEnhancedMultiAgent.\_get_agent_state_schema' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'MultiAgent.\_setup_schemas' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'MultiAgent.\_extract_agent_input' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'MultiAgent.\_extract_agent_input' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'MultiAgent.\_create_agent_output' uses overly generic type 'Any' for parameter 'result'
- 🔵 **Line 1**: Function 'MultiAgent.\_create_agent_output' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'MultiAgent.\_determine_next_node' uses overly generic type 'Any' for parameter 'result'
- 🔵 **Line 1**: Function 'MultiAgent.\_determine_next_node' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'MultiAgent.\_determine_next_node' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'MultiAgent.route_to_agent' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'MultiAgent.\_should_loop_coordinator' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'MultiAgent.is_complete' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'MultiAgent.should_continue' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'MultiAgent.aggregate_results' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'MultiAgent.aggregate_results' returns overly generic type 'Any'
...
- 🟡 **Line 1**: Module missing docstring
- 🔵 **Line 1**: Function 'deduplicate_and_format_sources' uses overly generic type 'Any' for parameter 'search_response'

### src/haive/agents/research/person/agent.py

- 🔵 **Line 173**: Method 'PersonResearchAgent.setup_workflow' missing type hints
- 🔵 **Line 1**: Function 'PersonResearchAgent.\_extract_json_from_text' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'load_recursive_web' parameter 'prevent_outside' name doesn't match type hint
...
- 🔵 **Line 1**: Function 'ResearchAgent.\_create_document_loader' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'ResearchAgent.save_state_history' might return None but type signature doesn't indicate Optional

### src/haive/agents/research/open_perplexity/cli.py

- 🔵 **Line 148**: Function 'main' missing type hints
- 🔵 **Line 1**: Function 'visualize_state' might return None but type signature doesn't indicate Optional
...
### src/haive/agents/common/utils/pydantic_prompt_utils.py

- 🔵 **Line 1**: Function 'analyze_pydantic_field' uses overly generic type 'Any' for parameter 'field_info'
...
- 🔵 **Line 1**: Function 'TaskAnalysis.\_generate_decomposition' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'CompositeGrade.validate_grade_value' uses overly generic type 'Any' for parameter 'value'
...
- 🔵 **Line 1**: Function 'Grade.validate_grade_value' uses overly generic type 'Any' for parameter 'value'
...
- 🔵 **Line 1**: Function 'RubricGrade.get_criterion_by_name' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'RubricGrade.validate_grade_value' uses overly generic type 'Any' for parameter 'value'
...
- 🔵 **Line 1**: Function 'NumericGrade.validate_grade_value' uses overly generic type 'Any' for parameter 'value'
...
- 🔵 **Line 1**: Function 'ScaleGrade.validate_grade_value' uses overly generic type 'Any' for parameter 'value'
...
- 🔵 **Line 1**: Function 'QualitativeGrade.validate_grade_value' uses overly generic type 'Any' for parameter 'value'
...
- 🔵 **Line 1**: Function 'LetterGrade.convert_to_letter_value' uses overly generic type 'Any' for parameter 'v'
- 🔵 **Line 1**: Function 'LetterGrade.validate_grade_value' uses overly generic type 'Any' for parameter 'value'
...
- 🔵 **Line 1**: Function 'BinaryGrade.convert_value_to_bool' uses overly generic type 'Any' for parameter 'v'
- 🔵 **Line 1**: Function 'BinaryGrade.validate_grade_value' uses overly generic type 'Any' for parameter 'value'
- 🔵 **Line 1**: Function 'BinaryGrade.create_pass' parameter 'confidence' name doesn't match type hint
- 🔵 **Line 1**: Function 'BinaryGrade.create_fail' parameter 'confidence' name doesn't match type hint
...
- 🔵 **Line 1**: Function 'HooksMixin.run_hooks' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'HooksMixin.run_hooks' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'HooksMixin.get_hook_result' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'HooksMixin.unregister_hook' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'PersistenceMixin.\_sync_persistence_fields_from_config' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'PersistenceMixin.\_setup_checkpointer_from_fields' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'PersistenceMixin.\_setup_async_checkpointer_from_fields' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'PersistenceMixin.\_setup_store_from_fields' might return None but type signature doesn't indicate Optional

### src/haive/agents/base/mixins/state_mixin.py

- 🟡 **Line 1**: Module missing docstring
- 🔵 **Line 339**: Method 'StateMixin.get_state_filename' missing type hints
- 🔵 **Line 1**: Function 'StateMixin.inspect_state' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'ReasoningMixin.reason' uses overly generic type 'Any' for parameter 'problem'
- 🔵 **Line 1**: Function 'ReasoningMixin.reason' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'ReasoningMixin.use_tool' returns overly generic type 'Any'

### src/haive/agents/base/mixins/execution_mixin.py

- 🟡 **Line 1**: Module missing docstring
- 🔵 **Line 1**: Function 'ExecutionMixin.\_prepare_input' uses overly generic type 'Any' for parameter 'input_data'
- 🔵 **Line 1**: Function 'ExecutionMixin.\_prepare_input' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'ExecutionMixin.\_process_output' uses overly generic type 'Any' for parameter 'output_data'
- 🔵 **Line 1**: Function 'ExecutionMixin.\_process_output' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'ExecutionMixin.run' uses overly generic type 'Any' for parameter 'input_data'
- 🔵 **Line 1**: Function 'ExecutionMixin.run' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'ExecutionMixin.stream' uses overly generic type 'Any' for parameter 'input_data'
- 🔵 **Line 1**: Function 'ExecutionMixin.\_process_stream_chunk' uses overly generic type 'Any' for parameter 'chunk'
...
- 🔵 **Line 1**: Function 'ExecutionPlan.get_phase_by_task' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'PlanAndExecuteState.get_next_step' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'RewooAgent.\_process_tool_input' uses overly generic type 'Any' for parameter 'tool_input'
- 🔵 **Line 1**: Function 'RewooAgent.\_process_tool_input' returns overly generic type 'Any'
...
- 🔵 **Line 1**: Function 'ExecutionMetrics.duration_seconds' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'PlanNode.get_resource_requirement' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'TaskDependency.resolve' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'CompilerStep.execute' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'CompilerPlan.get_join_step' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'CompilerPlan.get_step_by_id' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'LLMCompilerAgent.\_execute_step' returns overly generic type 'Any'
...
- 🔵 **Line 1**: Function '\_ast_parse' returns overly generic type 'Any'
...
- 🔵 **Line 1**: Function 'FLARERAGAgent.from_documents' parameter 'confidence_threshold' name doesn't match type hint
...
- 🔵 **Line 1**: Function 'SafeCompatibilityTester.\_safe_extract_output_schema' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'SafeCompatibilityTester.\_safe_extract_input_schema' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'parse_relevance_result' uses overly generic type 'Any' for parameter 'result'
- 🔵 **Line 1**: Function 'extract_answer' uses overly generic type 'Any' for parameter 'result'
...
- 🔵 **Line 1**: Function 'SQLDatabaseConfig.get_sql_db' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'GraphDBConfig.get_graph_db' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'GraphDBConfig.get_graph_db_schema' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'ReflectionAgentState.last_human_message' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'ReflectionAgentState.last_ai_message' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'Node.serialize_parent' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'TreeNode.best_child_score' might return None but type signature doesn't indicate Optional

### src/haive/agents/reasoning_and_critique/mcts/utils.py

- 🟡 **Line 1**: Module missing docstring
- 🔵 **Line 1**: Function 'extract_best_solution' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'print_tree_stats' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'ReactAgent.run' uses overly generic type 'Any' for parameter 'input_data'
- 🔵 **Line 1**: Function 'ReactAgent.run' returns overly generic type 'Any'
- 🔵 **Line 1**: Function 'ReactAgent.\_prepare_input' uses overly generic type 'Any' for parameter 'input_data'
...
- 🟡 **Line 1**: Module missing docstring
- 🔵 **Line 1**: Function 'create_custom_tool_node' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'get_tool_name' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'ReactAgentState.get' uses overly generic type 'Any' for parameter 'default'
- 🔵 **Line 1**: Function 'ReactAgentState.get' returns overly generic type 'Any'
...
- 🔵 **Line 1**: Function 'ReactManyToolsAgent.\_create_tool_embeddings' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'ReactAgent.\_route_agent_output' uses overly generic type 'Any' for parameter 'state'
...
- 🔵 **Line 733**: Method 'ComplexExtractionAgent.setup_workflow' missing type hints
- 🔵 **Line 1**: Function 'ComplexExtractionAgent.\_setup_extraction_tool' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'ComplexExtractionAgent.extract_node' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'Finalizer.**call**' uses overly generic type 'Any' for parameter 'state'
...
- 🔵 **Line 172**: Method 'SummarizerAgent.setup_workflow' missing type hints
- 🔵 **Line 564**: Function 'build_agent' missing type hints
...
- 🔵 **Line 1**: Function 'EntityRelationship.from_graph_relationship' parameter 'confidence_score' name doesn't match type hint
...
- 🔵 **Line 315**: Method 'IterativeGraphTransformer.setup_workflow' missing type hints
- 🔵 **Line 353**: Function 'build_agent' missing type hints
...
- 🔵 **Line 1**: Function 'SequentialMultiAgent.\_setup_node' uses overly generic type 'Any' for parameter 'state'
...
- 🔵 **Line 1**: Function 'CollaborativeConversation.\_check_section_completion' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'CollaborativeConversation.\_check_custom_end_conditions' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'BaseConversationAgent.initialize_conversation' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'BaseConversationAgent.select_speaker' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'BaseConversationAgent.execute_agent' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'BaseConversationAgent.process_response' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'BaseConversationAgent.check_end' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'BaseConversationAgent.conclude_conversation' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'BaseConversationAgent.\_custom_initialization' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'BaseConversationAgent.\_prepare_agent_input' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'BaseConversationAgent.\_extract_agent_messages' uses overly generic type 'Any' for parameter 'result'
- 🔵 **Line 1**: Function 'BaseConversationAgent.\_check_custom_end_conditions' uses overly generic type 'Any' for parameter 'state'
- 🔵 **Line 1**: Function 'BaseConversationAgent.\_check_custom_end_conditions' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'DebateConversation.\_extract_debate_winner' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'DebateConversation.\_check_custom_end_conditions' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'DirectedConversation.\_get_last_speaker_name' might return None but type signature doesn't indicate Optional
- 🔵 **Line 1**: Function 'DirectedConversation.\_check_custom_end_conditions' might return None but type signature doesn't indicate Optional
...
- 🔵 **Line 1**: Function 'SocialMediaConversation.\_check_custom_end_conditions' might return None but type signature doesn't indicate Optional
