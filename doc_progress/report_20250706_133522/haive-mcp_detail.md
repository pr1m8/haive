...
- 🟡 **Line 140**: Class 'Config' missing docstring

### src/haive/mcp/manager.py

- 🔵 **Line 205**: Method 'MCPManager.model_post_init' missing type hints
- 🔵 **Line 558**: Method 'MCPManager.get_all_server_status' missing type hints
...
- 🔵 **Line 149**: Method 'MCPAgent.setup_agent' missing type hints
- 🔵 **Line 251**: Method 'MCPAgent.get_available_capabilities' missing type hints
- 🔵 **Line 317**: Method 'MCPAgent.tool_count' missing type hints
...
### src/haive/mcp/integration/aug_llm_mcp_extension.py

- 🔵 **Line 244**: Method 'MCPAugLLMConfig.enhance_system_prompt_with_mcp' missing type hints
- 🔵 **Line 1**: Function 'MCPToolWrapper.\_run' returns overly generic type 'Any'

### src/haive/mcp/mixins/mcp_mixin.py

- 🔵 **Line 136**: Method 'MCPMixin.model_post_init' missing type hints
- 🔵 **Line 148**: Method 'MCPMixin.setup_mcp' missing type hints
- 🔵 **Line 478**: Method 'MCPMixin.get_mcp_status' missing type hints
